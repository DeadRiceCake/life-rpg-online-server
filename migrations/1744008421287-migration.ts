...
export class Migration1744008421287 implements MigrationInterface {
    name = 'Migration1744008421287'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TABLE "daily_todos" ("id" SERIAL NOT NULL, "name" character varying(50) NOT NULL, "description" character varying(255) NOT NULL DEFAULT '', "display_order" integer NOT NULL, "is_done" boolean NOT NULL DEFAULT false, "created_at" TIMESTAMP WITH TIME ZONE DEFAULT now(), "reward_stat" character varying NOT NULL DEFAULT 'strength', "hero_id" integer, CONSTRAINT "PK_90bca7d6b8c07c3ce8c6c596441" PRIMARY KEY ("id"))`);
